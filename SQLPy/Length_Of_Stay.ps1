...
$sqlscript
    ...
    "Set Up Stored Procedure:" + $sqlscript
...
$sqlquery
    ...
    "Invoke Stored Procedure:" + $sqlquery
    Invoke-Sqlcmd -ServerInstance $ServerName  -Database $DBName -Username $username -Password $password -Query $sqlquery -QueryTimeout 200000 -verbose >  C:\Users\t-tyrome\Documents\Internship\r-server-hospital-length-of-stay\SQLR\out.txt
}
